...
class Zend_Tool_Project_Context_Zf_ViewScriptFile extends Zend_Tool_Project_Context_Filesystem_File
{
     ...
     * @var string
     */
    protected $_filesystemName = 'view.tpl';
    ...
    public function init()
    {
        if ($forActionName = $this->_resource->getAttribute('forActionName')) {
            ...
            $this->_filesystemName = $this->_convertActionNameToFilesystemName($forActionName) . '.tpl';
        } elseif ($scriptName = $this->_resource->getAttribute('scriptName')) {
            $this->_scriptName = $scriptName;
            $this->_filesystemName = $scriptName . '.tpl';
        } else {
    ...
    public function getContents()
    {
        ...
        if ($this->_filesystemName == 'error.tpl') {  // should also check that the above directory is forController=error
            $contents .= <<<EOS
